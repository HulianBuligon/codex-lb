...
class DashboardSettingsResponse(DashboardModel):
    ...
    limit_warmup_exhausted_threshold_percent: float = Field(ge=0.0, le=100.0)
...
class DashboardSettingsUpdateRequest(DashboardModel):
    ...
    limit_warmup_exhausted_threshold_percent: float | None = Field(default=None, ge=0.0, le=100.0)
